...
This project was performed in the context of the Google Data Analytics Professional Certificate. This is the final Capstone project - case study. It is based on lectures given in the Google course and from personal research on the related techniques. The R programming language was used for this analysis.

### Introduction

Bellabeat is a high-tech manufacturer of health-focused products for women. Bellabeat believes that analyzing smart device fitness data could help unlock new growth opportunities for the company. The Bellabeat products are:
 ...
 - Time: wellness watch with smart technology to track user activity, sleep, and stress. The Time watch connects to the Bellabeat app.
...
This capstone project aimed to simulate real-world tasks of a junior data analyst. The aim is to focus on one of Bellabeat's products and analyze smart device data to gain insight into how consumers are using their smart devices. The information gathered will hopefully help the marketing team to develope a strategy to improve its products.

### Business task

Find trends in the data and explore what opportunities Bellabeat can gain from the insights of the data. It was decided to explore calories consumption as a function of intensity and number of steps.

### Data

#### Origin

The information was gathered from eligible Fitbit users who consented to the submission of their personal tracker data. It includes information about daily activity, steps, heart rate and includes a minute-level output for physical activity, heart rate and sleep monitoring. It is relatively old since this data was collected from April 12 to May 12 2016 and can be found in [data](https://www.kaggle.com/datasets/arashnic/fitbit):
The data has no metadata available so its not possible to understand how representative of the population of Bellabeat users this sample may be.

#### Packages

The packages used for this project were installed and loaded:
...
The data was previously downloaded into the computer and asigned to a variable in order to preserve original data. It was decided to use the hourly data for this analysis.
...
Find if the number of participant are the same:
